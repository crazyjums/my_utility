...
example = '''
###################### This is a example of my_fake_ua.py
1 get_user_agent()
usage: you can get a user-agent by random way.
```
import fake_ua # or from utility import fake_ua
headers = fake_ua.get_user_agent()
```
########################################################
'''
